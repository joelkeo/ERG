...
2. Computes the phase signal from the current buffer (in `PhaseSignal.h/.cpp`), based on events, but real logic is held in (`VRPS.h/.cpp` and its inheriting classes)
